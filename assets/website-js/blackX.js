...
const blackXContainer = document.getElementById('sketchBlackX');


function blackXsketch(sketch) {
    ...
    sketch.setup = function () {
        const containerSize = blackXContainer.getBoundingClientRect();
...
new p5(blackXsketch, blackXContainer)
