...
const ticTacToeContainer = document.getElementById('sketchTicTacToe')
...
function ticTacToeSketch(sketch) {
    ...
    sketch.preload = function () {
        for (let iC = 0; iC < 6; iC++) {
            imgArray.push(sketch.loadImage(`../assets/p5-projects/project-tictactoe/project-tictactoe-image-folder/image_${iC + 1}.jpeg`))
        }
    }
